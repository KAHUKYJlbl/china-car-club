...
export const Taxes = memo(
  ({ currentSpecification, setCurrentSpecification, techs }: TaxesProps) => {
          ...
          <div className={classes.block}>
            ...
            <div>
              <div className={cn(classes.row, classes.grey)}>
                ...
                <p>{priceFormat(getCurrencyExchange(techs.price.inChina, Currencies.CNY, currency))} {Currencies.CNY}</p>
              </div>
          ...
          <div className={classes.block}>
            ...
            <div>
              <div className={classes.flexRow}>
                ...
                <p>{priceFormat(getCurrencyExchange(getTaxes(currentTax, techs.price).duty, Currencies.RUB, currency))} {Currencies.RUB}</p>
              </div>

              <div className={classes.flexRow}>
                <p>таможенная пошлина</p>
                <p>{priceFormat(getCurrencyExchange(getTaxes(currentTax, techs.price).fee, Currencies.RUB, currency))} {Currencies.RUB}</p>
              </div>

              <div className={classes.flexRow}>
                <p>акциз</p>
                <p>{priceFormat(getCurrencyExchange(getTaxes(currentTax, techs.price).exciseTax, Currencies.RUB, currency))} {Currencies.RUB}</p>
              </div>

              <div className={classes.flexRow}>
                <p>ндс</p>
                <p>{priceFormat(getCurrencyExchange(getTaxes(currentTax, techs.price).nds, Currencies.RUB, currency))} {Currencies.RUB}</p>
              </div>
...

            {
              ...
              ? <>
                ...
                <p className={classes.grey}>
                  Физлицо может ввозить один автомобиль в&nbsp;год,
                  объёмом двигателя до&nbsp;3&nbsp;л, который остаётся
                  в&nbsp;собственности данного физлица не&nbsp;менее
                  1&nbsp;года. Если автомобиль не&nbsp;попадает под эти
                  критерии, то&nbsp;применяются повышенные
              ...
              : <>
                ...
                <p className={classes.grey}>
                  При ввозе автомобиля на&nbsp;юридическое лицо
                  оно имеет право получить налоговый вычет НДС
                  20% от&nbsp;стоимости растаможки автомобиля.
                </p>
              </>
            }
          </div>
