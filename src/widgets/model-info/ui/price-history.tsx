...
import {
  fetchSpecificationPriceHistory,
  getSpecifications,
...
export const PriceHistory = memo(({ currentSpecification, setCurrentSpecification }: PriceHistoryProps) => {
  ...
  return (
    <div className={classes.wrapper}>
      <div className={classes.block}>
        <h3 className={classes.header}>История цены в Китае</h3>
      ...
      <div className={classes.block}>
        <div className={classes.flexRow}>
          <p>История изменения цены {currentPrice}</p>
        </div>
