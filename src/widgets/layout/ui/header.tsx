...
import { DropdownHeader } from "../../../shared/ui/dropdown/ui/dropdown-header";
import {
  Currencies,
  getCurrencyName,
  getCurrentCurrency,
...
import { getCurrentCity, setCity } from "../../../entities/user";
import { HeaderUser } from "../../../entities/user/ui/header-user";
    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.mainWrapper}>
        <div className={classes.menuWrapper}>
          ...
          <HeaderButton label="menu" icon="menu" onClick={() => null} />
