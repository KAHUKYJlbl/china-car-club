    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content={
            window.location.pathname.includes("rolf")
              ? "Надёжный заказ авто из Китая с гарантией 2 года на автомобиль, только на Рольф Заказ. Быстрый онлайн расчёт заказа под ключ."
              : "Заказать новый авто из Китая по выгодной цене. Быстрый онлайн расчёт под ключ. По цене завода и с пожизненной поддержкой запчастями."
          }
        />
      </Helmet>
